...
class Core
{
    ...
    public function viewShares()
    {
        ...
        view()->share('avatarDef', asset(config('acc.sysconfig.default-avatar')));
        view()->share('adminAvatarDef', asset(config('acc.sysconfig.default-admin-avatar')));
    ...
    public function viewComposers()
    {
        view()->composer('*', function ($view) {
            $view->with([
                'authUser' => auth()->user(),
//                'pages' => Page::get(),
//                'termsPage' => Page::findBySlug('terms-and-conditions'),
//                'privacyPage' => Page::findBySlug('privacy-policy'),
//                'footerPages' => Page::whereIn('slug', ['terms-and-conditions', 'privacy-policy'])->get(),
    ...
    /**
     * getSupportedLocalesNames.
     */
    public function getSupportedLocalesNames()
    {
        return collect(LaravelLocalization::getSupportedLocales())->pluck('name')->all();
    }
