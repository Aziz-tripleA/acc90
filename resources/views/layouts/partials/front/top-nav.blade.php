    ...
    <div class="header-wrap sectionPad">
      <div class="header-top-wrap">
        ...
        <ul class="header-nav-list">
          ...
          <li class="header-nav-item">
            ...
            <ul>
              @foreach ($services as $service)
                <li> <a href="{{ route('service.index',['service'=>$service->name]) }}">{{$locale=='en'?GoogleTranslate::trans($service->name, $locale):$service->name}}</a></li>
              @endforeach
          </ul>
          </li>
          <li class="header-nav-item">
          ...
          <li class="header-nav-item">
            <a class="border-btn" href="{{ route('donate') }}"> {{$locale=='en'?GoogleTranslate::trans('لدعم الخدمه', $locale):'لدعم الخدمه'}}</a>
          </li>
        </ul>
        <ul class="header-extra-links">
          ...
          <li><a class="border-btn" href="{{ route('donate') }}"> {{$locale=='en'?GoogleTranslate::trans('لدعم الخدمه', $locale):'لدعم الخدمه'}}</a></li>
          <li>
      ...
      <div class="megamenu-links">
        ...
        <div class="megamenu-nav">
          <ul>
            ...
            <li><a href="{{ route('course.index') }}">{{$locale=='en'?GoogleTranslate::trans('مواد تعليمية ', $locale):'مواد تعليمية '}}</a></li>
            ...
            <li><a href="{{ route('contact') }}">{{$locale=='en'?GoogleTranslate::trans('اتصل بنا ', $locale):'اتصل بنا'}}</a></li>
            <li>
              <a class="border-btn" href="{{ route('donate') }}"> {{$locale=='en'?GoogleTranslate::trans('لدعم الخدمه', $locale):'لدعم الخدمه'}}</a>
            </li>
            <li>
