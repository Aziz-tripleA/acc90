...
<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-medium-1-1">
        <div class="md-card">
            <div class="md-card-toolbar">
                <h3 class="md-card-toolbar-heading-text">
                    Text for the donate page 
                </h3>
            </div>
            <div class="md-card-content"> 
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-medium-1-1" >
                        <label for="donate"> Transfer Options </label>
                        <textarea class="no_autosize tinymce" name="donate"
                                id="donate">{{isset($about)?$about->donate:''}}</textarea>
                        @include("layouts.partials.form-errors",['field'=>"donate"])
                    </div> 
                </div>
            </div>
        </div>
