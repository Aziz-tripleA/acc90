...
@section('title','General Numbers')
@section('d-buttons')
    @can('view_dashboard')
    <a href="{{route('abuse.admin.create')}}"
...
@section('d-content')
    <div class="md-card uk-margin-medium-bottom">
        <div class="md-card-content">
            <form action="{{route('abuse.admin.index')}}">
                ...
                <div class="uk-text-right mt-20">
                    <a class="md-btn md-btn-flat md-btn-wave waves-effect waves-button"
                       href="{{route('abuse.admin.index')}}">Reset Filters</a>
                    <button type="submit"
    ...
    @else
        <h3 class="uk-text-large ml-20">({{$abuses->total()}}) abuses</h3>
        <div class="md-card uk-margin-medium-bottom">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    <table class="uk-table uk-table-nowrap">
                        ...
                        @foreach($abuses as $abuse)
                            @include('pages.abuses.manager.partials.info')
                        @endforeach
                        </tbody>
                    </table>
        ...
        @include('layouts.admin.partials.pagination',['collection'=>$abuses])
    @endif
@endsection
