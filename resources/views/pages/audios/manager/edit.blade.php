...
@section('title','Edit Audio File')
@section('d-content')
    <form action="{{route('audio.admin.update',$audio->id)}}" method="POST" class="ajax" id="brandUpdate"
            ...
            <div class="uk-width-large-7-10">
                <div class="md-card">
                    ...
                    <div class="md-card-content">
                        @include('pages.audios.manager.partials.form')
                    </div>
                </div>
                <div class="uk-grid" data-uk-grid-margin>
