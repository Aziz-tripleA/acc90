...
@section('meta')
    ...
    <meta name="twitter:description"
          content="{{isset($book)?$book->item_name:'لنقدم المشورة والتعليم، والحث والتشجيع'}}"/>
    <meta name="twitter:image"
          content="{{isset($book) && $book->cover ? asset($book->getUrlFor('cover')) : asset('assets/images/default_image.png')}}"/>
        ...
        <div class="books-single-wrap sectionPad">
                ...
                <div class="books-single-img">
                    <div class="book-item">
                        <div class="book-item-img wow fadeInUp">
                            <img style="height:399px;width:300px"
                        ...
                        <div class="book-item-data wow fadeInUp">
                            <div class="book-item-content">
                                <ul>
                                    <li>
                                        <strong>اسم
                                            المؤلف </strong><span>{{ $book->author?$book->author->author_name:'' }}</span>
                                    </li>
                                    <li>
                        ...
                        <a class="order-btn wow fadeInUp" href="https://wa.me/+201227708916" target="_blank"> طلب
                            الكتاب </a>
                    </div>
            ...
            <div class="related-books">
                <div class="section-head wow fadeInUp">
                    ...
                    @if ($book->type_id == 3 )
                        <h2 class="section-title">كتب اخري تم تلخيصها </h2>
                    @else
