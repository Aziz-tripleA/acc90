...
@section('d-content')
    <form action="{{route('counselingType.admin.store')}}" method="POST" class="ajax" id="brandStore" enctype="multipart/form-data">
            ...
            <div class="uk-width-large-7-10">
                <div class="md-card">
                    ...
                    <div class="md-card-content">
                        @include('pages.counselingTypes.manager.partials.form')
                    </div>
                </div>
                <div class="uk-grid" data-uk-grid-margin>
