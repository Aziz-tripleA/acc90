...
@section('d-buttons')
    @can('view_dashboard')
    <a href="{{route('course.admin.create')}}"
...
@section('d-content')
    <div class="md-card uk-margin-medium-bottom">
        <div class="md-card-content">
            <form action="{{route('course.admin.index')}}">
                ...
                <div class="uk-text-right mt-20">
                    <a class="md-btn md-btn-flat md-btn-wave waves-effect waves-button"
                       href="{{route('course.admin.index')}}">Reset Filters</a>
                    <button type="submit"
    ...
    @else
        <h3 class="uk-text-large ml-20">({{$courses->total()}}) courses</h3>
        <div class="md-card uk-margin-medium-bottom">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    <table class="uk-table uk-table-nowrap">
                        ...
                        <tr>
                            ...
                            <th class="uk-width-4-10">Type</th>
                            <th class="uk-width-4-10">Topic</th>
                            <th class="uk-width-4-10">Lecturer</th>
                            <th class="uk-width-4-10">Status</th>
                        ...
                        @foreach($courses as $course)
                            @include('pages.courses.manager.partials.info')
                        @endforeach
                        </tbody>
                    </table>
        ...
        @include('layouts.admin.partials.pagination',['collection'=>$courses])
    @endif
@endsection
