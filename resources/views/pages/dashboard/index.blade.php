...
@section('d-buttons')
    <a href="#"
       data-action="{{route('home.admin.clearCache')}}"
       class="ajax_without_form md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light uk-float-right">
