...
@section('d-content')
    <form action="{{route('employee.admin.update',$employee->id)}}" method="POST" class="ajax" id="brandUpdate"
            ...
            <div class="uk-width-large-7-10">
                <div class="md-card">
                    ...
                    <div class="md-card-content">
                        @include('pages.employees.manager.partials.form')
                    </div>
                </div>
                <div class="uk-grid" data-uk-grid-margin>
                ...
                <div class="md-card">
                    <div class="md-card-content">
                        <div class="uk-float-right">
                            <input type="checkbox" @isset($employee)
