...
@section('d-buttons')
    @can('view_dashboard')
    <a href="{{route('employee.admin.create')}}"
...
@section('d-content')
    <div class="md-card uk-margin-medium-bottom">
        <div class="md-card-content">
            <form action="{{route('employee.admin.index')}}">
                ...
                <div class="uk-text-right mt-20">
                    <a class="md-btn md-btn-flat md-btn-wave waves-effect waves-button"
                       href="{{route('employee.admin.index')}}">Reset Filters</a>
                    <button type="submit"
    ...
    @else
        <h3 class="uk-text-large ml-20">({{$employees->total()}}) Employees</h3>
        <div class="md-card uk-margin-medium-bottom">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    <table class="uk-table uk-table-nowrap">
                        ...
                        <tr>
                            ...
                            <th class="uk-width-4-10">Position</th>
                            <th class="uk-width-3-10 uk-text-center">Actions</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($employees as $employee)
                            @include('pages.employees.manager.partials.info')
                        @endforeach
                        </tbody>
                    </table>
                </div>
        ...
        @include('layouts.admin.partials.pagination',['collection'=>$employees])
    @endif
@endsection
