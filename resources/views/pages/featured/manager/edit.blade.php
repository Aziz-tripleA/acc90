...
@section('title','Edit Featured Image')
@section('d-content')
    <form action="{{route('featured.admin.update',$featured->id)}}" method="POST" class="" id="brandUpdate"
        ...
        <div class="uk-grid" data-uk-grid-margin>
            <div class="uk-width-large-7-10">
                <div class="md-card">
                    ...
                    <div class="md-card-content">
                        @include('pages.featured.manager.partials.form')
                    </div>
                </div>
                <div class="uk-grid" data-uk-grid-margin>
            ...
            {{-- <div class="uk-width-large-3-10">
                ...
                <button
                    ...
                    data-action="{{route('featured.admin.destroy',$featured->id)}}"
                    data-append-input="1"
