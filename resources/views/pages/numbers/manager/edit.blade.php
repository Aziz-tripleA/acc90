...
@section('d-content')
    <form action="{{route('number.admin.update',$number->id)}}" method="POST" class="ajax" id="brandUpdate"
            ...
            <div class="uk-width-large-7-10">
                <div class="md-card">
                    ...
                    <div class="md-card-content">
                        @include('pages.numbers.manager.partials.form')
                    </div>
                </div>
                <div class="uk-grid" data-uk-grid-margin>
                ...
                <div class="md-card">
                    <div class="md-card-content">
                        <div class="uk-float-right">
                            <input type="checkbox" @isset($number)
                                @if($number->is_active) checked @endif
