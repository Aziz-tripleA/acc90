...
@section('title','Ministry numbers')
@section('d-buttons')
    @can('view_dashboard')
    <a href="{{route('number.admin.create')}}"
...
@section('d-content')
    <div class="md-card uk-margin-medium-bottom">
        <div class="md-card-content">
            <form action="{{route('number.admin.index')}}">
                ...
                <div class="uk-text-right mt-20">
                    <a class="md-btn md-btn-flat md-btn-wave waves-effect waves-button"
                       href="{{route('number.admin.index')}}">Reset Filters</a>
                    <button type="submit"
    ...
    @else
        <h3 class="uk-text-large ml-20">({{$numbers->total()}}) numbers</h3>
        <div class="md-card uk-margin-medium-bottom">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    <table class="uk-table uk-table-nowrap">
                        ...
                        @foreach($numbers as $number)
                            @include('pages.numbers.manager.partials.info')
                        @endforeach
                        </tbody>
                    </table>
        ...
        @include('layouts.admin.partials.pagination',['collection'=>$numbers])
    @endif
@endsection
