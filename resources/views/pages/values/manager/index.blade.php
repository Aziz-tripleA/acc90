...
@section('d-buttons')
    @can('view_dashboard')
    <a href="{{route('value.admin.create')}}"
...
@section('d-content')
    <div class="md-card uk-margin-medium-bottom">
        <div class="md-card-content">
            <form action="{{route('value.admin.index')}}">
                ...
                <div class="uk-text-right mt-20">
                    <a class="md-btn md-btn-flat md-btn-wave waves-effect waves-button"
                       href="{{route('value.admin.index')}}">Reset Filters</a>
                    <button type="submit"
    ...
    @else
        <h3 class="uk-text-large ml-20">({{$values->total()}}) Values</h3>
        <div class="md-card uk-margin-medium-bottom">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    <table class="uk-table uk-table-nowrap">
                        ...
                        @foreach($values as $value)
                            @include('pages.values.manager.partials.info')
                        @endforeach
                        </tbody>
                    </table>
        ...
        @include('layouts.admin.partials.pagination',['collection'=>$values])
    @endif
@endsection
