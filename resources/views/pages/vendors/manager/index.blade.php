...
@section('d-buttons')
    ...
    <a href="{{route('vendor.admin.create')}}"
...
@section('d-content')
    <div class="md-card uk-margin-medium-bottom">
        <div class="md-card-content">
            <form action="{{route('vendor.admin.index')}}">
                ...
                <div class="uk-text-right mt-20">
                    <a class="md-btn md-btn-flat md-btn-wave waves-effect waves-button"
                       href="{{route('vendor.admin.index')}}">Reset Filters</a>
                    <button type="submit"
    ...
    @else
        <h3 class="uk-text-large ml-20">({{$vendors->total()}}) Vendors</h3>
        <div class="md-card uk-margin-medium-bottom">
            <div class="md-card-content">
...
{{--                            <th class="uk-width-2-10">Products</th>--}}
        ...
        @include('layouts.admin.partials.pagination',['collection'=>$vendors])
    @endif
@endsection
